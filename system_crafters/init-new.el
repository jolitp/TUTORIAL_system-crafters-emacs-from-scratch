...
;; removes extra UI elements
(scroll-bar-mode -1) ;; disable visible scrollbar
(tool-bar-mode -1) ;; disable the toolbar
(tooltip-mode -1) ;; disable tooltips
(menu-bar-mode -1) ;; disable the menu bar

;; give some breathin room?
(set-fringe-mode 10) 

;; set up the visual bell instead of sound
(setq visible-bell t)   
...
(dolist
  (mode '(
 	org-mode-hook
;; I want line numbers in org-mode
;; now that org mode stays in the 
;; middle of the screen
;; line numbers in org files look weird
 	term-mode-hook
 	shell-mode-hook
        eshel-mode-hook
        )
...
(defun efs/org-babel-tangle-config ()
  (when (string-equal (buffer-file-name)
                      (expand-file-name "~/.system-crafters/emacs.org"))
